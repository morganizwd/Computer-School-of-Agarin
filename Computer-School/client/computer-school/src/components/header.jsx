...
const pages = [
    ...
    { title: 'Админка курсы', path: '/adminka2', adminOnly: true },
    { title: 'Админка группы', path: '/adminka3', adminOnly: true },
    { title: 'Админка расписание', path: '/adminka4', adminOnly: true },
    { title: 'Админка преподаватели', path: '/adminka1', adminOnly: true },
];
